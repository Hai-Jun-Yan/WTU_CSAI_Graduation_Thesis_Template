...
% 缺失的仿宋_GB2312和楷体_GB2312字体问题还未解决
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figs/Stranger_Things.jpg} 
    % 中文标题
    \caption{怪奇物语}
    \vspace{-9pt}
    % 英文标题
    \caption*{{Fig. \thefigure} Stranger Things}
    \label{chapter3-fig:Stranger-Things}
\end{figure}
...
\section{图片引用示例}
这里展示图片引用：如图 \ref{chapter3-fig:Stranger-Things} 所示，如图 \ref{fig:tv-series-samples}（a）、\ref{fig:tv-series-samples}（b）、\ref{fig:tv-series-samples}（c）和 \ref{fig:tv-series-samples}（d） 所示。
