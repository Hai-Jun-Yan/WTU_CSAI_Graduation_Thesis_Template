...
% GitHub: https://github.com/dux1n4real

% 2025-11-24 v2.0
% 作者 2：严海军// 机构：武汉纺织大学计算机与人工智能学院// 联系方式：yanhaijun66@gmail.com (欢迎联系！)
% Author 2: Yan Haijun // Institution: School of Computer Science and Artificial Intelligence, Wuhan Textile University // Email: yanhaijun666@gmail.com (Welcome to contact!)
% GitHub: https://github.com/Hai-Jun-Yan/WTU_CSAI_Graduation_Thesis_Template
% 个人博客: https://www.blog-haijun.site/
...
% 希望各位毕业的学弟学妹们在使用本模板的过程中能够遇到最少的问题，也欢迎各位在使用过程中遇到的问题与我联系。祝大家顺利毕业！
% 个人博客: https://www.blog-haijun.site/
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                  定义图\表标题字体及样式
%       Define Figure/Table Caption Font and Style
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%        To remove colored boxes from links, use:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                定义公式编号格式：式(3.1)
%           Define Equation Numbering Format: (3.1)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                    自动参考文献管理设置
%         Automatic Reference Management Settings
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1. 加载 natbib 宏包
% square: 方括号 []
...
% ========================================================
%                    第一章：一级标题示例
%           Chapter 1: First-Level Heading Example
% ========================================================
\chapter{一级标题示例}
...
% ========================================================
%                  第二章（图表与公式排版）
%      Chapter 2: Figures, Tables, and Equations Layout
% ========================================================
\chapter{第二章（图表与公式排版）}
...
% ========================================================
%                第四章（参考文献引用示例）
%          Chapter 4: Reference Citation Examples
% ========================================================
...
\subsection{单篇文献引用示例}
(1) \textbf{上标引用}：在正文叙述完一个观点后，使用 \texttt{\textbackslash cite\{key\}} 命令。引用标记会自动变为右上角上标。

\textbf{示例：}
引用了一个单独的文献\cite{niu1}

(2) \textbf{行内引用}：如果需要将引用作为句子的一部分，使用 \texttt{\textbackslash citen\{key\}} 命令。

\textbf{示例：}
文献\citen{niu1}详细讨论了这个问题。
...
\subsection{文献编排样式展示}
文献\cite{niu1}为硕士学位论文\citenum{ASPP}
